<meta charset="<?php echo CONFIG_SITE_CHARSET; ?>">
        ...
        <link rel="stylesheet" href="<?php echo CONFIG_INSTALL_URL; ?>/assets/style/tailwind-custom.min.css">
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.2/css/all.css" integrity="sha384-vSIIfh2YWi9wW0r9iZe7RJPrKwp6bG+s9QZMoITbCckVJqGCCRhc+ccxNcdpHuYu" crossorigin="anonymous">
        <link rel="stylesheet" href="<?php echo CONFIG_INSTALL_URL; ?>/assets/common/panel/styles.css">
