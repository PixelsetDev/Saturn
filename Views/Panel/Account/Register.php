...
<html lang="<?= PANEL_LANGUAGE; ?>" class="min-h-full">
    <head>
        ...
        <title><?= $TL->TL('Register'); ?> - <?= WEBSITE_NAME; ?></title>
    </head>
        ...
        <div class="my-16 max-w-sm mx-auto bg-neutral-300 dark:bg-neutral-800">
            ...
            <form class="bg-neutral-200 text-black dark:bg-neutral-700 dark:text-white w-full h-full" action="" method="POST">
                <div class="md:px-6 md:py-8 sm:px-4 sm:py-6 px-2 py-4">
                    <h1 class="text-3xl text-center font-bold mb-8"><?= $TL->TL('Register'); ?></h1>
                    <input type="text" name="firstname" id="firstname" maxlength="63" required placeholder="<?= $TL->TL('FirstName'); ?>" class="input-full">
                    <input type="text" name="lastname" id="lastname" maxlength="63" required placeholder="<?= $TL->TL('LastName'); ?>" class="input-full">
                    ...
                    <input type="password" name="confirmpassword" id="confirmpassword" maxlength="255" required placeholder="<?= $TL->TL('ConfirmPassword'); ?>" class="input-full">
                </div>
