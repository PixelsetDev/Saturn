    ...
    <body class="bg-gray-200">
        ...
        <div class="px-8 py-4 w-full">
            ...
            <div class="flex my-6 space-x-4">
                <a href="<?php echo CONFIG_INSTALL_URL; ?>/panel/upload/?type=image&uploadTo=/assets/images/&renameTo=icon.png&redirectTo=<?php echo CONFIG_INSTALL_URL; ?>/panel/admin/themes&maxHeight=400&maxWidth=400" class="w-1/6 p-4 relative overflow-hidden rounded-md bg-white shadow hover:shadow-xl transition duration-200">
                ...
                <a href="<?php echo CONFIG_INSTALL_URL; ?>/panel/upload/?type=image&uploadTo=/assets/images/&renameTo=logo.png&redirectTo=<?php echo CONFIG_INSTALL_URL; ?>/panel/admin/themes&maxHeight=200&maxWidth=1000"  class="w-1/6 p-4 relative overflow-hidden rounded-md bg-white shadow hover:shadow-xl transition duration-200">
                ...
                <a href="<?php echo CONFIG_INSTALL_URL; ?>/panel/upload/?type=image&uploadTo=/assets/images/&renameTo=defaultprofile.png&redirectTo=<?php echo CONFIG_INSTALL_URL; ?>/panel/admin/themes&maxHeight=400&maxWidth=400"  class="w-1/6 p-4 relative overflow-hidden rounded-md bg-white shadow hover:shadow-xl transition duration-200">
