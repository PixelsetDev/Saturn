    ...
    <body class="bg-gray-200">
        ...
        <div class="px-8 py-4 w-full">
            ...
            <form class="w-full" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                ?>
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_General'); ?></label></li>
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Panel:Panel'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_Users'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_Database'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_Email'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_Notifications'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_PagesArticles'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_Security'); ?></label></li>
                        <li class="grid grid-cols-2">
                    ...
                    <div class="mt-4">
                        <li><label class="text-gray-900 text-2xl pb-4 mb-1"><?php echo __('Admin:Settings_Developer'); ?></label></li>
