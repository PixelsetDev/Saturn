        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <article class="mt-5 flex space-x-4 overflow-x-scroll">
                ...
                <a href="<?php echo $result[1]; ?>" target="_blank" class="relative flex-none" style="width:300px; height:300px">
                    <iframe src="<?php echo $result[1]; ?>?access_method=saturn_iframe_preview" rel="noopener" class="cursor-pointer relative flex-none" title="Preview of Page Titled <?php echo $result[0]; ?>" style="width:300px; height:300px"></iframe>
