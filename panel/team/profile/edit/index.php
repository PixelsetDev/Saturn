            ...
            <div class="w-full h-48" style="background: url('<?php echo CONFIG_INSTALL_URL; ?>/assets/panel/images/background.jpg');">
                <div class="max-w-7xl flex mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                    <div class="h-32 w-32 py-2 px-2 md:h-48 md:w-48 md:py-4 md:px-4 relative inline-block">
                        <a href="<?php echo CONFIG_INSTALL_URL; ?>/panel/files/upload/?type=profilepicture&redirectTo=<?php echo CONFIG_INSTALL_URL; ?>/panel/team/profile/edit&maxHeight=1000&maxWidth=1000"><img class="h-28 w-28 md:h-40 md:w-40 bg-white rounded-full" src="<?php echo get_user_profilephoto($user); ?>" alt="<?php echo get_user_fullname($user); ?>"></a>
