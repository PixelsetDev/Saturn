<?php ob_start(); session_start();
    ...
    if (isset($_POST['message'])) {
        ...
        $message = checkInput('DEFAULT', $_POST['message']);
        $message = str_replace('"', '&quot;', $message);
        $query = 'INSERT INTO `'.DATABASE_PREFIX."chats_messages` (`id`, `user_id`, `chat_id`, `status`, `message`, `datetime`) VALUES (NULL, '".checkInput('DEFAULT', $_SESSION['id'])."', '1', 'ACTIVE', '".$message."', CURRENT_TIMESTAMP);";
        $rs = mysqli_query($conn, $query);
                ...
                <div class="col-span-2 bg-white">
                    <div class="w-full">
                            ...
                            <ul>
                                    ...
                                    <li class="w-full flex justify-end">
                                        <div class="flex bg-gray-100 rounded px-5 py-2 my-2 text-gray-700 relative" style="max-width: 300px;">
                                            ...
                                            <div class="ml-2">
                                                <span class="block break-words">'.$row['message'].'</span>
                        ...
                        <form method="POST" action="" class="w-full py-3 px-3 flex items-center justify-between border-t border-gray-300">
                            <button onClick="Javascript:alert('Coming soon.');" class="outline-none focus:outline-none" name="Upload image" aria-label="Upload image">
                            ...
                            <button onClick="Javascript:alert('Coming soon.');" class="outline-none focus:outline-none ml-1" name="Upload file" aria-label="Upload file">
                                <svg class="text-gray-400 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
