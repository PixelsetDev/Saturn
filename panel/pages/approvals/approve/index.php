                                        ...
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-2">
                                                <p class="text-sm text-gray-500">
                                                    Are you sure you want to deny all changes to this page?<br> This action cannot be undone.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="sm:flex sm:items-start">
                                        ...
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-2">
                                                <p class="text-sm text-gray-500">
                                                    Are you sure you want to approve all changes to this page?<br> This action cannot be undone.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
