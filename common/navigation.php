<div class="z-40 absolute top-0 left-0 right-0" x-data="{ open: false }">
    <nav class="bg-gray-900 shadow-lg">
        <div class="max-w-7xl mx-auto px-8">
            <div class="flex items-center justify-between h-16">
                <div class="w-full justify-between flex items-center">
                    <a class="flex-shrink-0" href="<?php echo CONFIG_INSTALL_URL; ?>">
                        <img class="h-10 w-auto" src="<?php echo CONFIG_INSTALL_URL; ?>/storage/images/logo.png" alt="Saturn"/>
                    </a>
                ...
                <div class="-mr-2 flex md:hidden">
                    <button @click="open = !open" class="text-gray-800 dark:text-white hover:text-gray-300 inline-flex items-center justify-center p-2 rounded-md focus:outline-none">
