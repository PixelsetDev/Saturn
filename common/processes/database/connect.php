<?php
    ...
    if (mysqli_connect_errno()) {
        ...
        <p class="w-full text-center">Sorry, a fatal error has occurred whilst trying to display this page and Saturn was unable to recover.</p>
        ...
        <div class="duration-300 transform bg-red-100 border-l-4 border-red-500 mt-32 mx-32">
            <div class="h-auto p-5 border border-l-0 rounded-r shadow-sm">
                <h6 class="mb-2 font-semibold leading-5">[<?php echo date('H:i') ?>]
        ...
        <p class="bg-black text-white p-2 rounded w-auto mt-8 mx-32">
            MYSQLI_CONNECT_ERRNO(<?php echo mysqli_connect_errno(); ?>) - <?php echo mysqli_connect_error(); ?>
        </p>
        <?php } ?>
