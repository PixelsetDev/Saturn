                                                                    ...
                                                                    <div class="w-full font-semibold inline-block py-2 px-3 uppercase rounded text-gray-900 dark:bg-neutral-800 dark:text-white bg-gray-100">
                                                                        <div class="flex w-full relative space-x-3">
                                                                            <div class="flex-grow">
                                                                                ...
                                                                                <input id="pagetitle" name="pagetitle" type="text" maxlength="100" required class="dark:bg-neutral-700 appearance-none relative block w-full px-3 py-2 border border-gray-300 dark:border-neutral-900 placeholder-gray-500 dark:placeholder-white text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-'.THEME_PANEL_COLOUR.'-500 focus:border-'.THEME_PANEL_COLOUR.'-500 focus:z-10 sm:text-sm" placeholder="Page Title">
                                                                            </div>
                                                                            <div class="flex-grow hidden">
                                                                                <label for="pagecategory" class="sr-only">Category</label>
                                                                                <input id="pagecategory" name="pagecategory" type="text" value="'.$category.'" maxlength="100" required class="dark:bg-neutral-700 appearance-none relative block w-full px-3 py-2 border border-gray-300 dark:border-neutral-900 placeholder-gray-500 dark:placeholder-white text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-'.THEME_PANEL_COLOUR.'-500 focus:border-'.THEME_PANEL_COLOUR.'-500 focus:z-10 sm:text-sm" placeholder="Page Category">
                                                                            </div>
                                                                    ...
                                                                    <div class="w-full font-semibold inline-block rounded text-gray-900 dark:text-white">
                                                                        <div class="flex w-full relative space-x-3">
                                                                            <div class="flex-grow">
                                                                                ...
                                                                                <input id="categorytitle" name="categorytitle" type="text" maxlength="100" required class="dark:bg-neutral-600 appearance-none relative block w-full px-3 py-2 border border-gray-300 dark:border-neutral-900 placeholder-gray-500 dark:placeholder-white text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-'.THEME_PANEL_COLOUR.'-500 focus:border-'.THEME_PANEL_COLOUR.'-500 focus:z-10 sm:text-sm" placeholder="Category Name">
                                                                            </div>
