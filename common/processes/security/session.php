<?php
    function countdownJavascript(): string
    {
        ...
        var downloadTimer = setInterval(function(){
            ...
            if(timeleft <= 0){
                ...
                document.getElementById("sessionCountdown").innerHTML = "<div class=\"mb-6 mr-6 bg-red-50 dark:bg-red-500 border-l-4 border-red-500 dark:border-red-900 dark:text-white p-2 shadow-md hover:shadow-xl flex transition duration-200\"><i class=\"px-2 fas fa-times text-red-500 dark:text-red-900 fa-2x self-center\" aria-hidden=\"true\"></i><h6 class=\"p-3 font-semibold leading-5\">Your session has expired. If you attempt to make any changes it may result in your work being lost. Please <a href=\"/panel\" class=\"underline\" target=\"_blank\" onclick=\"clearCountdown();\">click here</a> to log back in.</h6></div>";
            } else if (timeleft < 60) {
                document.getElementById("sessionCountdown").innerHTML = "<div class=\"mb-6 mr-6 bg-yellow-50 dark:bg-yellow-500 border-l-4 border-yellow-500 dark:border-yellow-900 dark:text-white p-2 shadow-md hover:shadow-xl flex transition duration-200\"><i class=\"px-2 fas fa-exclamation-triangle text-yellow-500 dark:text-yellow-900 fa-2x self-center\" aria-hidden=\"true\"></i><h6 class=\"p-3 font-semibold leading-5\">Your session will expire in " + timeleft + " seconds. Please save your work now.</h6></div>";
            } else if (timeleft < 120) {
    ...
    echo '<div class="absolute bottom-0 right-0" id="sessionCountdown"></div><script>'.countdownJavascript().'</script>';